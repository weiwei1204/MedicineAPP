...
public class CheckBeacon_Time extends Service {
    String memberid;
...
//        memberid=bundle.getString("memberid");
    ...
    public void onStart(Intent intent, int startId) {
        Toast.makeText(this, "Time Service Start", Toast.LENGTH_SHORT).show();
...
//        getbeacon();
    ...
    public void onDestroy(){
        super.onDestroy();
        Toast.makeText(this, "Time Service Stop", Toast.LENGTH_SHORT).show();
